      ...
      <div className="" id='Loginchangediv'>
        <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
          <li class="nav-item" role="presentation">
            <Link class="nav-link  Loginchangebtn1 " id="tab-login" data-mdb-toggle="pill" to="/Login" role="tab"
              aria-controls="pills-login" aria-selected="true">Student Login</Link>
          </li>
          <li class="nav-item" role="presentation">
            <Link class="nav-link active Loginchangebtn2 loginbtnbackcol" id="tab-register" data-mdb-toggle="pill" to="/LoginStartUp" role="tab"
