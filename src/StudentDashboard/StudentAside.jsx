      ...
      >
        <ul class="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3 ">
          ...
          <li class="nav-item mb-2 ">
            <Link class="nav-link text-secondary" to="/StudentDashboard">
          ...
          <li class="nav-item mb-2 ">
            <Link class="nav-link text-secondary" to="/Studentprofile">
              <i class="fas fa-user font-weight-bold"></i>{" "}
              <span className="ml-3">Profile</span>
            </Link>
          </li>
          <li class="nav-item mb-2">
            <Link class="nav-link text-secondary" to="/Notification">
              Notifications
            </Link>
          </li>
        </ul>
